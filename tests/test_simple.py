...
from bifrost_amrfinderplus import launcher
import pymongo
import os
import shutil
...
class TestBifrostAMRFinderPlus:
    component_name = "amrfinderplus__v1_0_0"
    component_name = component_name #+ "__d98c13b"
    current_dir = os.getcwd()
    test_dir = "/bifrost/test_data/output/test__amrfinderplus/"
    json_entries = [
        {
            ...
            "categories": {
                "contigs": {
                    "summary": {
                        "data": ["/bifrost/test_data/samples/S1/assemblatron__v2_2_16/contigs.fasta"]
